...
import br.prontoconsulta.service_consultas.exceptions.HttpApiException;
import br.prontoconsulta.service_consultas.exceptions.HttpApiExceptionResponse;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  private ResponseEntity<HttpApiExceptionResponse> serviceUnavailableExceptionHandler(ServiceUnavailableException e) {
    return getResponse(HttpStatus.SERVICE_UNAVAILABLE.value(), "Serviço temporariamente indisponível. Dados limitados podem estar sendo exibidos.");
  }
